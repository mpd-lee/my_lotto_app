...
st.markdown("""
    ...
    div[data-testid="column"] div.stButton > button p, div[data-testid="column"] div.stButton > button span {
        font-size: 20px !important;
        font-weight: 900 !important;
        color: #FFFFFF !important;
    }
    ...
    /* 🚀 하단 일반 번호 추출 버튼 스타일 */
    div.stButton > button:not(div[data-testid="column"] div.stButton > button):not(button[kind="primary"]) {
    ...
    div.stButton > button:not(div[data-testid="column"] div.stButton > button):not(button[kind="primary"]):hover { 
